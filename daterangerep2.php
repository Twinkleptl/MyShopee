...
$qry1="select count(orderid),billdate, sum(billamount), sum(discount), sum(paidamount) from orderdetails$shopid where billdate>='$startdate' and billdate<='$enddate' and username='$username' group by billdate";
 // echo $qry1;
...
<tr style="background-color:#562929;color:white;">
	...
	<tr><th colspan="7"style="background-color:#562929;color:white; text-align: center;" > TOTAL ORDERS (DAYWISE) REPORT OF SELLER:<?php echo $username?></th></tr>
...
$qry2="select sum(paidamount) from orderdetails$shopid where billdate='$rowbilldate' and paidby='cash' and username='$username'";
$result2= $conn->query($qry2);
$row2=$result2->fetch_assoc();
print"<td> {$row2['sum(paidamount)']}</td>";
$qry3="select sum(paidamount) from orderdetails$shopid where billdate='$rowbilldate' and paidby='other' and username='$username'";
...
$qrychart1="select billdate,sum(paidamount) from orderdetails$shopid where username='$username' and billdate>='$startdate' and billdate<='$enddate' group by billdate";
...
<tr>
	...
	<th colspan="7"style="background-color:#562929;color:white; text-align: center;" > INDIVIDUAL ORDERS OF DAYWISE OF <?php echo $startdate;?> TO <?php echo $enddate;?> SELLER <?php echo $username;?></th></tr>
	...
	<tr style="background-color:#562929;color:white; text-align: center;">
	    ...
	    <th>PAYSTATUS</th></tr>
<?php
$qry4="SELECT orderid,billdate,billamount,discount,paidamount,paidby,paystatus from orderdetails$shopid where billdate>='$startdate' and billdate<='$enddate'and username='$username' order by orderid ";
  //echo $qry;
...
$qrychart2="select orderid,paidamount from orderdetails$shopid where username='$username' and billdate>='$startdate' and billdate<='$enddate'";
